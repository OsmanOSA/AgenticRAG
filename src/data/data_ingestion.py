...
from src.entity.artifact_entity import DocChunks, TextChunk, TableChunk, ImageChunk
...
class PdfIngestion:
    ...
    @staticmethod
    def text_chunks(all_chunks: Dict[str, DocChunks]
                    ) -> List[TextChunk]:
    ...
    @staticmethod
    def table_chunks(all_chunks: Dict[str, DocChunks]
                     ) -> List[TableChunk]:
    ...
    @staticmethod
    def image_chunks(all_chunks: Dict[str, DocChunks]
                     ) -> List[ImageChunk]:
